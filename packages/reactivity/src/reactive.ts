...
enum TargetType {
  INVALID = 0, // 无效类型
  COMMON = 1, // 普通对象或数组
  COLLECTION = 2, // 集合类型（如 Map、Set 等）
}

// 根据原始类型字符串映射到 TargetType
 ...
 */
// isReactive 函数：检查对象是否是由 reactive 或 shallowReactive 创建的代理
 ...
 */
// isProxy 函数：检查对象是否是由 reactive、readonly 等创建的代理
